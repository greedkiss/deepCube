...
sys.path.append(os.path.join(BASE_DIR, 'code/solvers/cube3'))
...
def getResults(state):
    ...
    parser.add_argument('one', type=str, nargs=1, help="Which methods to use. Comma separated list")

    parser.add_argument('two', type=str, nargs=1, help="Which methods to use. Comma separated list")
    ...
    parser.add_argument('--model_loc', type=str, default=BASE_DIR + "/code/savedModels/cube3/1/", help="Location of model")
    ...
    # Environment = environments.env_utils.getEnvironment('cube3')
